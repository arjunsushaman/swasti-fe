...
import { SITE_NAME, CONTACT_INFO, NAV_ITEMS } from '@/lib/constants';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/labs" className="text-sm hover:text-primary-400 transition-colors">
                  Laboratory Services
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <svg
                  className="w-5 h-5 mt-0.5 flex-shrink-0 text-primary-400"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <a
                  ...
                  className="text-sm hover:text-primary-400 transition-colors"
                >
                  {CONTACT_INFO.streetAddress}
                </a>
              </li>
              <li className="flex items-center gap-3">
                <svg
                  className="w-5 h-5 flex-shrink-0 text-primary-400"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-sm">{CONTACT_INFO.clinicHours}</span>
              </li>
            </ul>
          </div>
        </div>
