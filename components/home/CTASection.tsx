    ...
    <AnimatedSection className="py-24 relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <p className="text-xl text-primary-100 mb-10 max-w-2xl mx-auto leading-relaxed text-justify md:text-center">
          ...
          <p className="mt-12 text-primary-200/80 text-sm">
            <a href={CONTACT_INFO.phoneLink} className="hover:text-white transition-colors border-b border-white/20 pb-0.5 hover:border-white">
              {CONTACT_INFO.phone}
            </a>
