    ...
    <AnimatedSection className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
        <div className="text-center mb-16 max-w-4xl mx-auto">
          ...
          <p className="text-lg text-secondary-600 leading-relaxed text-balance text-justify md:text-center">
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <div className="relative z-10 px-4 md:px-5 pb-4 md:pb-5">
                      <p className="text-secondary-600 leading-relaxed font-medium text-sm md:text-base text-justify md:text-center">
                        {service.description}
                      </p>
                    </div>
                  </div>
