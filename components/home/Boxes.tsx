...
function Box({ icon, title, description, index }: BoxProps) {
  ...
  return (
    ...
    >
      ...
      <p className="text-secondary-600 leading-relaxed font-medium text-justify md:text-center lg:text-sm">{description}</p>
    </motion.div>
  );
}
    ...
    <AnimatedSection className="py-24 bg-white relative">
      ...
      <div className="container-custom relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="section-subheading max-w-2xl mx-auto text-lg text-secondary-600 text-justify md:text-center">
