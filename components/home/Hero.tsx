      ...
      <div className="container-custom relative">
        <div className="py-16 md:py-24 lg:py-32">
          <div className="max-w-4xl mx-auto text-center">
            ...
            {/* Sub Line */}
            <p className="text-lg md:text-xl text-secondary-600 mb-8 leading-relaxed max-w-3xl mx-auto">
              {SUB_LINE}
            </p>
            ...
            {/* Contact info */}
            <div className="mt-8 flex flex-wrap justify-center gap-6 text-secondary-500 text-sm">
              <a
