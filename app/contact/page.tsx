...
export const metadata: Metadata = {
  title: 'Contact Us',
  description:
    'Get in touch with Swasti Lifecare. Find our address, phone number, and clinic hours. We\'re here to help with your healthcare needs.',
};
      ...
      <div className="container-custom">
        ...
        <div className="text-center mb-12">
          ...
          <p className="section-subheading max-w-2xl mx-auto">
            We&apos;re here to help. Reach out to us with any questions or to schedule an
            appointment.
          </p>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="card p-0 overflow-hidden">
              <div className="aspect-video bg-secondary-100 flex items-center justify-center">
                <div className="text-center p-8">
                  ...
                  <p className="text-secondary-500 mb-4">Interactive map coming soon</p>
                  <a
                    href={CONTACT_INFO.locationLink}
                    target="_blank"
                    rel="noopener noreferrer"
            ...
            <div className="card bg-primary-600 text-white">
              ...
              <p className="text-primary-100 mb-6">
                Skip the wait — book your appointment online and we&apos;ll confirm your slot.
              </p>
              <Link
                href="/booking"
                className="inline-flex items-center justify-center rounded-lg bg-white px-6 py-3 text-base font-medium text-primary-600 shadow-sm transition-all duration-200 hover:bg-primary-50 w-full"
              >
                Book Appointment
              </Link>
            </div>
            ...
            <div className="card">
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="font-medium text-secondary-900">Do I need an appointment?</h4>
                  <p className="text-secondary-600 text-sm mt-1">
                    Walk-ins are welcome for general consultations. For specialist visits, prior
                    appointment is recommended.
                  </p>
                </div>
                <div>
                  <h4 className="font-medium text-secondary-900">Is parking available?</h4>
                  <p className="text-secondary-600 text-sm mt-1">
                    Yes, free parking is available for patients at the clinic.
                  </p>
                </div>
                <div>
                  <h4 className="font-medium text-secondary-900">Do you accept insurance?</h4>
                  <p className="text-secondary-600 text-sm mt-1">
                    Please contact us for information about insurance acceptance and cashless
                    facilities.
                  </p>
                </div>
              </div>
